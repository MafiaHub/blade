...
extern void Cmd_Assign_f(edict_t *ent);
extern void Cmd_Unassign_f(edict_t *ent);
...
extern void Cmd_UseWorld_f(edict_t *ent);
...
extern qboolean IsQuestInProgress(int questid);
